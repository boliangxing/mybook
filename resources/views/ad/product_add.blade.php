    ...
    callback:function(form){
      $('#form-product-add').ajaxSubmit({
          ...
          data: {
            ...
            preview: ($('#preview_id').attr('src')!='/ad/images/icon-add.png'?$('#preview_id').attr('src'):''),
            content: ue.getContent(),
            preview1: ($('#preview_id1').attr('src')!='/ad/images/icon-add.png'?$('#preview_id1').attr('src'):''),
            preview2: ($('#preview_id2').attr('src')!='/ad/images/icon-add.png'?$('#preview_id2').attr('src'):''),
            preview3: ($('#preview_id3').attr('src')!='/ad/images/icon-add.png'?$('#preview_id3').attr('src'):''),
            preview4: ($('#preview_id4').attr('src')!='/ad/images/icon-add.png'?$('#preview_id4').attr('src'):''),
            preview5: ($('#preview_id5').attr('src')!='/ad/images/icon-add.png'?$('#preview_id5').attr('src'):''),
            _token: "{{csrf_token()}}"
          },
