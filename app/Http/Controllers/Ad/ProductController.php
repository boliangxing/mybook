...
class ProductController extends Controller
{
  public function toProduct()
  {
    ...
    return view('ad.product')->with('products', $products);
  }
  public function toProductInfo(Request $request) {
    ...
    return view('ad.product_info')->with('product', $product)
                                     ->with('pdt_content', $pdt_content)
                                     ->with('pdt_images', $pdt_images);
  }
  public function toProductAdd() {
    $categories = Category::whereNotNull('paraent_id')->get();
    return view('ad.product_add')->with('categories', $categories);
  }
  /********************Service*********************/
